...
class Plotter:
    ...
    def __init__(
        ...
        self.pen = Pen(servo_3, bg=self, pw_up=pw_up, pw_down=pw_down, virtual=self.virtual)
    ...
    def setup_turtle(self, coarseness):
        ...
        try:
            ...
            print("turtle plotter unavailable")
    ...
    def set_pulse_widths(self, pw_1=None, pw_2=None):
        ...
        if self.virtual:
            ...
            if pw_1:
                ...
                self.servo_1.goto(pw_1)
            if pw_2:
                self.servo_2.goto(pw_2)
...
class Pen:
    def __init__(self, servo: servo.Servo, bg, pw_up=1700, pw_down=1300, transition_time=0.25, virtual=False):
        self.servo = servo
        self.bg = bg
        self.pw_up = pw_up
    ...
    def down(self):
        ...
        if self.position == "up":
            ...
            if self.virtual:
                ...
                # self.rpi.set_servo_pulsewidth(MOTOR3, self.pw_down)
    ...
    def up(self):
        ...
        if self.position == "down":
            ...
            if self.virtual:
                ...
                # self.rpi.set_servo_pulsewidth(MOTOR3, self.pw_up)
